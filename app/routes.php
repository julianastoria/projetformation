<?php
	...
	$w_routes = array(
		...
		//Doctors Routes
		['GET', '/medecin/[a:type]/liste', 'Doctors#index', 'doctors_index'],
		...
		//Institutions Routes
		['GET', '/etablissement/[a:type]/liste', 'Institutions#index', 'instutions_index'],
		['GET', '/etablissement/[i:id]/details', 'Institutions#read', 'instution_details'],
